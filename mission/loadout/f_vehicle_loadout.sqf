...
case "crate_large":
{
	...
	_unit addMagazineCargoGlobal [_riflemag_tr, 20];
	_unit addMagazineCargoGlobal [_glriflemag, 80];
	_unit addMagazineCargoGlobal [_glriflemag_tr, 20];
	_unit addMagazineCargoGlobal [_carbinemag, 80];
	_unit addMagazineCargoGlobal [_carbinemag_tr, 20];
	_unit addMagazineCargoGlobal ["vn_m1897_fl_mag", 80];
	_unit addMagazineCargoGlobal ["vn_m1928_mag", 80];
	_unit addMagazineCargoGlobal [_smgmag, 20];
	_unit addMagazineCargoGlobal [_armag, 80];
	_unit addMagazineCargoGlobal [_armag_tr, 20];
	_unit addMagazineCargoGlobal [_MMGmag, 80];
